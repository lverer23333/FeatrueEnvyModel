...
def text8Train():
    ...
    # sentences = word2vec.Text8Corpus("E:/PycharmProjects/FeatureEnvy-master/Algorithm/allcode.txt")
...
def moreTrain():
    ...
    more_sentences = word2vec.Text8Corpus(u"allcode.txt")
    # more_sentences = word2vec.Text8Corpus("E:/PycharmProjects/FeatureEnvy-master/Algorithm/allcode.txt")
